...
@flight_routes.route('/add_flights', methods=['GET', 'POST'])
...
@flight_routes.route('/delete/<string:flight_id>')
@user_decorators.requires_login
def delete_flight(flight_id):
	Flight.get_by_id(flight_id).delete()
	return redirect(url_for('.index'))

@flight_routes.route('/booking_flight/<string:flight_id>', methods=['GET', 'POST'])
